...
<<create_methy450batch_object, cache = FALSE, echo = TRUE, include = TRUE>>=
...
<<print_x.methy450, cache = FALSE, echo = TRUE, include = TRUE>>
...
<<region_level_regression, dev = 'pdf', fig.width=4, fig.height=4, cache = FALSE, echo = TRUE, eval = TRUE>>=
...
<<region_regr_summary, cache = FALSE, eval = TRUE>>=
length(regr.site.pv)
